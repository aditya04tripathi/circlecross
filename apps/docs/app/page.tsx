...
import { LinkButton, Arrow, Mark } from "../components/ui";
			...
			<main id="main">
				...
				<section className="idea section-space" id="idea">
					...
					<div className="idea-bottom" data-reveal>
						...
						<p>
							CircleCross brings the people, places and communities around you a little
							closer. So a chance encounter can become something that matters.
						</p>

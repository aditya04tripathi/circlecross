...
import type { IndexablePath } from "../content/seo";
import { getOgLines } from "../content/seo";
...
export function createOgImage(path: IndexablePath): ImageResponse {
